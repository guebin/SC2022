...
# ╔═╡ 1309cb46-7027-45b4-9401-0ed38a1ef7a7
md"""
	이 강의노트의 PD-matrix는 일부문헌의 정의를 사용하여 설명한 것입니다. (예시는 아래..)

	- Golub, G. H., & Van Loan, C. (1979). Unsymmetric positive definite linear systems. Linear Algebra and its Applications, 28, 85-97.

	현재는 PD-matrix가 실대칭행렬(or 에르미트행렬)임을 전재하고 서술한 문현이 많으므로 해당내용으로 공부하시기 바랍니다. 2024년 강의노트 버전 <https://github.com/guebin/SC2024> 에서는 다른 정의로 PD를 설명합니다. 
"""
...
md"""
`-` 정의: 어떠한 실대칭행렬 ${\bf A}_{n\times n}$가 모든 non-zero real vector ${\bf y}_{n \times 1}$에 대하여 
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "1fb51a3a2be50adf36eba7104e57e2aef7a5de82"
